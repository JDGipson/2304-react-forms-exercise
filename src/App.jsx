      ...
      <div>
        ...
        */}
        ...
        <form onSubmit={sendNewPostReq}>
          <label htmlFor="newPostTitle">Enter New Blog Post Title Below:</label>
          <input
            title="newPostTitle"
            type="text"
          ...
          ></input>
          <label htmlFor="newPostBody">Enter New Body Post Below:</label>
          <input
            name="newPostBody"
            type="text"
            placeholder="New Body Post Goes Here"
            value={newPostBody}
            onChange={(event) => {
